    ...
    <div className="relative flex w-full flex-col">
      <div className="absolute left-0 top-0 z-0 h-full w-full">
        <div className="relative flex w-full flex-col justify-between lg:flex-row">
          <div className="-translate-x-[70vw] -translate-y-[10%] md:-translate-x-[15vw] lg:w-[auto] lg:-translate-x-[0] lg:-translate-y-[0]">
            <BGLeftIcon />
          </div>
          ...
          <div className="-translate-y-[90vw] translate-x-[25vw] md:-translate-y-[70vw] md:translate-x-[60vw] lg:w-[auto] lg:-translate-y-[0] lg:translate-x-[0]">
