      ...
      <BannerBg>
        <div className="flex min-h-[800px] w-full flex-col items-center justify-center px-8 py-6">
          ...
          <div className="mt-10 flex w-full items-center justify-center">
            <button className="btn-primary mr-4 flex items-center justify-center px-4 lg:px-8 py-2">
              <GetStartIcon />
              Get Started
            </button>
            <button className="btn-secondary flex items-center justify-center px-4 lg:px-8 py-2">
              <JoinBetaIcon />
              Join the Beta
            </button>
          </div>
